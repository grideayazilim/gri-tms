...
# Bu script yalnızca ilk kurulumda çalışır; aynı yetki listesi docker-setup.ts
# ve migrator.ts içinde de var, biri değişirse diğerleri de güncellenmeli.
# TRUNCATE'i sistem sıfırlaması kullanıyor.
